...
const acceptCall = async () => {
    ...
    return (
        <div className="container">
            ...
            {isCalling && (
                <div className="video-call-window">
                    ...
                    <video
                        ...
                        autoPlay
                        playsInline
                        style={{ width: "100%", height: "300px", backgroundColor: "black", border: "2px solid red" }}
                                    ...
                                    src={
                                        currentUser.avatar
                                            ? currentUser.avatar.startsWith("http")
                                                ...
                                                : `${backendUrl}${currentUser.avatar}` // Agar purani local file hai
            ...
            {/* Chat section */}
            <div className="chat-conatiner"> {/* Reverted: jaisa aapke CSS mein tha */}
                        ...
                        {showArchived && (
                            <div className="archived-chats">
                                {users
                                    ...
                                    .map((chat, k) => (
                                        <div key={k} className="chat-item archived" onClick={() => setSelectedChat(chat)}> {/* Added missing key */}
                                            <img
                                                src={
                                                    chat.avatar
                                                        ? chat.avatar.startsWith("http")
                                                            ? chat.avatar
                                                            : `${backendUrl}${chat.avatar}`
                                                        : "./user.png"
                                                }
                                                alt="avatar"
                                    ...
                                    src={
                                        selectedChat.avatar
                                            ? selectedChat.avatar.startsWith("http")
                                                ? selectedChat.avatar
                                                : `${backendUrl}${selectedChat.avatar}`
                                            : "./user.png"
                                    }
                                    alt="avatar"
